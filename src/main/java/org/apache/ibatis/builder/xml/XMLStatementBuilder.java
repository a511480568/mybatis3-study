...
public class XMLStatementBuilder extends BaseBuilder {
  ...
  public void parseStatementNode() {
    ...
    // 这个是解析 select|update|insert|delete 标签内的 <include refid = "xxx"></include> 标签
    ...
    // 这里是拿到 sqlSource，通过 RawLanguageDriver 最后调用到 XMLScriptBuilder#parseScriptNode 方法，如果是动态 sql，则会生成 DynamicSqlSource，否则会生成 RawSqlSource
    SqlSource sqlSource = langDriver.createSqlSource(configuration, context, parameterTypeClass);
    // 这里是拿到 statementType，默认是 prepared，即后续创建的 preparedStatement 的类型
    ...
    // 这里就是构建 MappedStatement，把标签中的所有属性都塞进去了
