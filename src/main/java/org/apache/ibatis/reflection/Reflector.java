...
public class Reflector {
  ...
  // 能够读的属性列表，即有 getter 方法的属性
  private final String[] readablePropertyNames;
  // 能够写的属性列表，即有 setter 方法的属性
  private final String[] writablePropertyNames;
  // setter 方法映射表，key 为属性名，value 为属性对应的 setter 方法
  private final Map<String, Invoker> setMethods = new HashMap<>();
  // getter 方法映射表，key 为属性名，value 为属性对应的 getter 方法
  private final Map<String, Invoker> getMethods = new HashMap<>();
  // setter 方法参数类型映射表，key 为属性名，value 为属性对应的 setter 方法的参数类型
  private final Map<String, Class<?>> setTypes = new HashMap<>();
  // getter 方法参数类型映射表，key 为属性名，value 为属性对应的 getter 方法的参数类型
