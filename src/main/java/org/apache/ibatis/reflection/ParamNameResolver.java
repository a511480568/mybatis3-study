...
public class ParamNameResolver {
   ...
   * </ul>
   */
  // 方法输入参数的次序，key 为参数次序（索引），value 为参数名称或者参数 @Param 注解的值
  ...
  public ParamNameResolver(Configuration config, Method method) {
    ...
    // TODO 这里为什么要使用 paramAnnotations 这个变量的长度作为后续 for 循环的循环次数
    // 至于为什么要用 paramAnnotations 的长度作为 for 循环的次数限制，可以看 《通用源码阅读指导书：MyBatis源码解读》中的第七章最后的介绍！！！
